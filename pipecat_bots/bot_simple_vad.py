...
#
# This is a copy of bot.py with the following changes:
# - NO SmartTurn analyzer (just plain Silero VAD)
# - Default stop_secs=0.8 (800ms silence before turn end)
#
# Usage:
...
# Using default stop_secs=0.8 (800ms) instead of 0.2 (200ms)
transport_params = {
...
async def run_bot(transport: BaseTransport, runner_args: RunnerArguments):
    ...
    logger.info(f"Starting SIMPLE VAD bot (local ASR, {llm_mode} LLM, {tts_type} TTS)")
        ...
        if USE_WEBSOCKET_TTS:
            tts = MagpieWebSocketTTSService(
                ...
                params=MagpieWebSocketTTSService.InputParams(
                    ...
                    use_adaptive_mode=USE_CHUNKED_LLM,
                ),
            )
